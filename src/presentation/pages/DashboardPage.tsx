  ...
  return (
    <div className="space-y-7">
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_1.28fr]">
        <article className="soft-card p-7"><h3 className="text-xl font-black">📖 Continue Learning</h3><div className="mt-5 flex items-center gap-5"><Mascot type="dog" size="lg" /><div className="flex-1"><h4 className="text-4xl font-black">run <span className="text-xl text-muted">/rʌn/</span></h4><p className="mt-1 text-lg font-bold text-muted">chạy</p><div className="mt-5"><ProgressBar value={75} color="#47B453" /></div><button className="mt-5 rounded-2xl bg-success px-7 py-3 font-black text-white transition hover:scale-105">Continue</button></div></div></article>
        <article className="soft-card p-7"><div className="flex gap-5"><div className="flex-1"><h3 className="text-2xl font-black">Daily Goal</h3><p className="mt-2 text-muted">Learn 10 new words</p><p className="mt-6 text-3xl font-black">{Math.min(stats.studiedWords, 10)} / 10</p><div className="mt-3"><ProgressBar value={goal} color="#F4C95D" /></div><button className="mt-6 rounded-2xl bg-primary px-7 py-3 font-black text-white transition hover:scale-105">Start Learning</button></div><Mascot type="bear" size="lg" /></div></article>
      </section>
